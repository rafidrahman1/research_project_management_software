<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPageAdmin.master" AutoEventWireup="true" CodeFile="research_division.aspx.cs" Inherits="Default2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="card-body">
        ...
        <ol>
            ...
            <li>A clear opinion is required 'Yes/No' wether the project is <u>Ethically</u> acceptable according to the project title, objectives and desired outcomes.</li>
        </ol>
        ...
        <table border="1" cellpadding="10">
            ...
            <tr>
                <td>Ethically accepted</td>
                <td>
                    <input type="checkbox" id="yes" name="ethics" value="Yes" onclick="updateEthics('Yes')"><strong style="padding: 5px">Yes</strong></td>
                <td>
                    <input type="checkbox" id="no" name="ethics" value="No" onclick="updateEthics('No')" style="padding: 5px"><strong style="padding: 5px">No</strong></td>
                <td id="ethicsValue"></td>
            </tr>
        </table>
