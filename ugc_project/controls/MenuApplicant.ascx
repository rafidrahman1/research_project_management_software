<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MenuApplicant.ascx.cs" Inherits="controls_header" %>
<!-- Navbar -->
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a href="DashboardApplicant.aspx" class="nav-link">Application Form</a>
                </li>
