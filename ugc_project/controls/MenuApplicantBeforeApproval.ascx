<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MenuApplicantBeforeApproval.ascx.cs" Inherits="controls_header" %>
<!-- Navbar -->
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse order-3" id="navbarCollapse">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a href="AppointmentApplicant.aspx" class="nav-link">Appointment</a>
                </li>
